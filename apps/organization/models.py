...
class CityDict(models.Model):
    ...
    desc = models.TextField(verbose_name='城市描绘')
...
class CourseOrg(models.Model):
    ...
    category = models.CharField(choices=(('pxjg', '培训机构'), ('gr', '个人'), ('gx', '高校')), max_length=4, default='pxjg', verbose_name='机构类别')
    desc = models.TextField(verbose_name='机构描绘')
